    ...
    <footer class="nav-footer">
        ...
        <div class="section-1">
            ...
            <nav aria-label="Footer Navigation">
                <ul>
                    <li 
                        v-for="link in FooterNavLinks[0]"
                    >
                ...
                <ul>
                    <li 
                        v-for="link in FooterNavLinks[1]"
                    >
                        <a :href="link.link"> {{ link.name }} </a>
                    </li>
                </ul>
        ...
        <div class="section-2">
            <TheButton text="Request Invite" />
            <p>© Easybank. All Rights Reserved</p>
            
            <TheCredits 
                linkFrontendMentor="https://www.frontendmentor.io/challenges/easybank-landing-page-WaUhkoDN"
                linkGithub="https://github.com/VickyAzola/EasybankLandingPage"
            />
        </div>
